...
class ExtrudeObject():
    ...
    def SetOffsetValue(self, value):
        ...
        if value > 0 and bpy.context.object.modifiers["DestructiveBoolean"].operation == 'UNION':
            bpy.context.object.modifiers["DestructiveBoolean"].operation = 'DIFFERENCE'
        elif value < 0 and bpy.context.object.modifiers["DestructiveBoolean"].operation == 'DIFFERENCE':
            bpy.context.object.modifiers["DestructiveBoolean"].operation = 'UNION'
